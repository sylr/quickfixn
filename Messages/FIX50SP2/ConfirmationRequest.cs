...
namespace QuickFix
{
    namespace FIX50SP2
    {
        public class ConfirmationRequest : Message
        {
            ...
            {
                public static int[] fieldOrder = { Tags.ClOrdID, Tags.OrderID, Tags.SecondaryOrderID, Tags.SecondaryClOrdID, Tags.ListID, Tags.NoNested2PartyIDs, Tags.OrderQty, Tags.OrderAvgPx, Tags.OrderBookingQty, Tags.OrdType, 0 };
                ...
                {
                    public static int[] fieldOrder = { Tags.Nested2PartyID, Tags.Nested2PartyIDSource, Tags.Nested2PartyRole, Tags.NoNested2PartySubIDs, Tags.Nested2PartyRoleQualifier, 0 };
                    ...
                    public QuickFix.Fields.Nested2PartyRoleQualifier Nested2PartyRoleQualifier
                    {
                        get
                        {
                            QuickFix.Fields.Nested2PartyRoleQualifier val = new QuickFix.Fields.Nested2PartyRoleQualifier();
                            GetField(val);
                            return val;
                        }
                        set { SetField(value); }
                    ...
                    public void Set(QuickFix.Fields.Nested2PartyRoleQualifier val)
                    {
                        this.Nested2PartyRoleQualifier = val;
                    }

                    public QuickFix.Fields.Nested2PartyRoleQualifier Get(QuickFix.Fields.Nested2PartyRoleQualifier val)
                    {
                        GetField(val);
                        return val;
                    }

                    public bool IsSet(QuickFix.Fields.Nested2PartyRoleQualifier val)
                    {
                        return IsSetNested2PartyRoleQualifier();
                    }

                    public bool IsSetNested2PartyRoleQualifier()
                    {
                        return IsSetField(Tags.Nested2PartyRoleQualifier);
                    }
