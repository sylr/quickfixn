...
namespace QuickFix
{
    namespace FIX50SP2
    {
        public class PartyEntitlementsUpdateReport : Message
        {
            public const string MsgType = "CZ";

            public PartyEntitlementsUpdateReport() : base()
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("CZ"));
            }
