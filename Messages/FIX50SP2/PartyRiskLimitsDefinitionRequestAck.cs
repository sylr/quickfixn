...
namespace QuickFix
{
    namespace FIX50SP2
    {
        public class PartyRiskLimitsDefinitionRequestAck : Message
        {
            public const string MsgType = "CT";

            public PartyRiskLimitsDefinitionRequestAck() : base()
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("CT"));
            }

            public PartyRiskLimitsDefinitionRequestAck(
                    QuickFix.Fields.RiskLimitRequestID aRiskLimitRequestID,
                    QuickFix.Fields.RiskLimitRequestStatus aRiskLimitRequestStatus
                ) : this()
            {
                this.RiskLimitRequestID = aRiskLimitRequestID;
                this.RiskLimitRequestStatus = aRiskLimitRequestStatus;
            }
            ...
            public QuickFix.Fields.RiskLimitRequestResult RiskLimitRequestResult
            {
                get
                {
                    QuickFix.Fields.RiskLimitRequestResult val = new QuickFix.Fields.RiskLimitRequestResult();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.RiskLimitRequestResult val)
            {
                this.RiskLimitRequestResult = val;
            }

            public QuickFix.Fields.RiskLimitRequestResult Get(QuickFix.Fields.RiskLimitRequestResult val)
            {
                GetField(val);
                return val;
            }

            public bool IsSet(QuickFix.Fields.RiskLimitRequestResult val)
            {
                return IsSetRiskLimitRequestResult();
            }

            public bool IsSetRiskLimitRequestResult()
            {
                return IsSetField(Tags.RiskLimitRequestResult);
            }
            public QuickFix.Fields.RiskLimitRequestStatus RiskLimitRequestStatus
            {
                get
                {
                    QuickFix.Fields.RiskLimitRequestStatus val = new QuickFix.Fields.RiskLimitRequestStatus();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.RiskLimitRequestStatus val)
            {
                this.RiskLimitRequestStatus = val;
            }

            public QuickFix.Fields.RiskLimitRequestStatus Get(QuickFix.Fields.RiskLimitRequestStatus val)
            {
                GetField(val);
                return val;
            }

            public bool IsSet(QuickFix.Fields.RiskLimitRequestStatus val)
            {
                return IsSetRiskLimitRequestStatus();
            }

            public bool IsSetRiskLimitRequestStatus()
            {
                return IsSetField(Tags.RiskLimitRequestStatus);
            }
            ...
            {
                public static int[] fieldOrder = { Tags.ListUpdateAction, Tags.RiskLimitStatus, Tags.RiskLimitResult, Tags.NoPartyDetails, Tags.NoRiskLimits, Tags.RiskLimitID, Tags.RejectText, Tags.EncodedRejectTextLen, Tags.EncodedRejectText, Tags.RiskLimitCheckModelType, Tags.PartyRiskLimitStatus, 0 };
                ...
                public QuickFix.Fields.RiskLimitStatus RiskLimitStatus
                {
                    get
                    {
                        QuickFix.Fields.RiskLimitStatus val = new QuickFix.Fields.RiskLimitStatus();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.RiskLimitStatus val)
                {
                    this.RiskLimitStatus = val;
                }

                public QuickFix.Fields.RiskLimitStatus Get(QuickFix.Fields.RiskLimitStatus val)
                {
                    GetField(val);
                    return val;
                }

                public bool IsSet(QuickFix.Fields.RiskLimitStatus val)
                {
                    return IsSetRiskLimitStatus();
                }

                public bool IsSetRiskLimitStatus()
                {
                    return IsSetField(Tags.RiskLimitStatus);
                }
                public QuickFix.Fields.RiskLimitResult RiskLimitResult
                {
                    get
                    {
                        QuickFix.Fields.RiskLimitResult val = new QuickFix.Fields.RiskLimitResult();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.RiskLimitResult val)
                {
                    this.RiskLimitResult = val;
                }

                public QuickFix.Fields.RiskLimitResult Get(QuickFix.Fields.RiskLimitResult val)
                {
                    GetField(val);
                    return val;
                }

                public bool IsSet(QuickFix.Fields.RiskLimitResult val)
                {
                    return IsSetRiskLimitResult();
                }

                public bool IsSetRiskLimitResult()
                {
                    return IsSetField(Tags.RiskLimitResult);
                }
