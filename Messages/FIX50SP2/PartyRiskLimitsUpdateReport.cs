...
namespace QuickFix
{
    namespace FIX50SP2
    {
        public class PartyRiskLimitsUpdateReport : Message
        {
            public const string MsgType = "CR";

            public PartyRiskLimitsUpdateReport() : base()
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("CR"));
            }
