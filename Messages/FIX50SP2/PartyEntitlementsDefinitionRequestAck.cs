...
namespace QuickFix
{
    namespace FIX50SP2
    {
        public class PartyEntitlementsDefinitionRequestAck : Message
        {
            public const string MsgType = "DB";

            public PartyEntitlementsDefinitionRequestAck() : base()
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("DB"));
            }

            public PartyEntitlementsDefinitionRequestAck(
                    QuickFix.Fields.EntitlementRequestID aEntitlementRequestID,
                    QuickFix.Fields.EntitlementRequestStatus aEntitlementRequestStatus
                ) : this()
            {
                this.EntitlementRequestID = aEntitlementRequestID;
                this.EntitlementRequestStatus = aEntitlementRequestStatus;
            }
            ...
            public QuickFix.Fields.EntitlementRequestStatus EntitlementRequestStatus
            {
                get
                {
                    QuickFix.Fields.EntitlementRequestStatus val = new QuickFix.Fields.EntitlementRequestStatus();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.EntitlementRequestStatus val)
            {
                this.EntitlementRequestStatus = val;
            }

            public QuickFix.Fields.EntitlementRequestStatus Get(QuickFix.Fields.EntitlementRequestStatus val)
            {
                GetField(val);
                return val;
            }

            public bool IsSet(QuickFix.Fields.EntitlementRequestStatus val)
            {
                return IsSetEntitlementRequestStatus();
            }

            public bool IsSetEntitlementRequestStatus()
            {
                return IsSetField(Tags.EntitlementRequestStatus);
            }
            public QuickFix.Fields.EntitlementRequestResult EntitlementRequestResult
            {
                get
                {
                    QuickFix.Fields.EntitlementRequestResult val = new QuickFix.Fields.EntitlementRequestResult();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.EntitlementRequestResult val)
            {
                this.EntitlementRequestResult = val;
            }

            public QuickFix.Fields.EntitlementRequestResult Get(QuickFix.Fields.EntitlementRequestResult val)
            {
                GetField(val);
                return val;
            }

            public bool IsSet(QuickFix.Fields.EntitlementRequestResult val)
            {
                return IsSetEntitlementRequestResult();
            }

            public bool IsSetEntitlementRequestResult()
            {
                return IsSetField(Tags.EntitlementRequestResult);
            }
            ...
            {
                public static int[] fieldOrder = { Tags.ListUpdateAction, Tags.EntitlementStatus, Tags.EntitlementResult, Tags.RejectText, Tags.EncodedRejectTextLen, Tags.EncodedRejectText, Tags.NoPartyDetails, Tags.NoEntitlements, Tags.EntitlementRefID, 0 };

                public NoPartyEntitlementsGroup()
                  : base(Tags.NoPartyEntitlements, Tags.ListUpdateAction, fieldOrder)
                {
                }
                ...
                public QuickFix.Fields.EntitlementResult EntitlementResult
                {
                    get
                    {
                        QuickFix.Fields.EntitlementResult val = new QuickFix.Fields.EntitlementResult();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.EntitlementResult val)
                {
                    this.EntitlementResult = val;
                }

                public QuickFix.Fields.EntitlementResult Get(QuickFix.Fields.EntitlementResult val)
                {
                    GetField(val);
                    return val;
                }

                public bool IsSet(QuickFix.Fields.EntitlementResult val)
                {
                    return IsSetEntitlementResult();
                }

                public bool IsSetEntitlementResult()
                {
                    return IsSetField(Tags.EntitlementResult);
                }
                ...
                public QuickFix.Fields.EntitlementRefID EntitlementRefID
                {
                    get
                    {
                        QuickFix.Fields.EntitlementRefID val = new QuickFix.Fields.EntitlementRefID();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.EntitlementRefID val)
                {
                    this.EntitlementRefID = val;
                }

                public QuickFix.Fields.EntitlementRefID Get(QuickFix.Fields.EntitlementRefID val)
                {
                    GetField(val);
                    return val;
                }

                public bool IsSet(QuickFix.Fields.EntitlementRefID val)
                {
                    return IsSetEntitlementRefID();
                }

                public bool IsSetEntitlementRefID()
                {
                    return IsSetField(Tags.EntitlementRefID);
                }
