...
namespace QuickFix
{
    namespace FIX50SP2
    {
        public class PartyRiskLimitsReportAck : Message
        {
            public const string MsgType = "DE";

            public PartyRiskLimitsReportAck() : base()
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("DE"));
            }

            public PartyRiskLimitsReportAck(
                    QuickFix.Fields.RiskLimitReportID aRiskLimitReportID,
                    QuickFix.Fields.RiskLimitReportStatus aRiskLimitReportStatus
                ) : this()
            {
                this.RiskLimitReportID = aRiskLimitReportID;
                this.RiskLimitReportStatus = aRiskLimitReportStatus;
            }

            public QuickFix.Fields.RiskLimitReportID RiskLimitReportID
            {
                get
                {
                    QuickFix.Fields.RiskLimitReportID val = new QuickFix.Fields.RiskLimitReportID();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.RiskLimitReportID val)
            {
                this.RiskLimitReportID = val;
            }

            public QuickFix.Fields.RiskLimitReportID Get(QuickFix.Fields.RiskLimitReportID val)
            {
                GetField(val);
                return val;
            }

            public bool IsSet(QuickFix.Fields.RiskLimitReportID val)
            {
                return IsSetRiskLimitReportID();
            }

            public bool IsSetRiskLimitReportID()
            {
                return IsSetField(Tags.RiskLimitReportID);
            }
            ...
            public QuickFix.Fields.RiskLimitReportStatus RiskLimitReportStatus
            {
                get
                {
                    QuickFix.Fields.RiskLimitReportStatus val = new QuickFix.Fields.RiskLimitReportStatus();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.RiskLimitReportStatus val)
            {
                this.RiskLimitReportStatus = val;
            }

            public QuickFix.Fields.RiskLimitReportStatus Get(QuickFix.Fields.RiskLimitReportStatus val)
            {
                GetField(val);
                return val;
            }

            public bool IsSet(QuickFix.Fields.RiskLimitReportStatus val)
            {
                return IsSetRiskLimitReportStatus();
            }

            public bool IsSetRiskLimitReportStatus()
            {
                return IsSetField(Tags.RiskLimitReportStatus);
            }
            public QuickFix.Fields.RiskLimitReportRejectReason RiskLimitReportRejectReason
            {
                get
                {
                    QuickFix.Fields.RiskLimitReportRejectReason val = new QuickFix.Fields.RiskLimitReportRejectReason();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.RiskLimitReportRejectReason val)
            {
                this.RiskLimitReportRejectReason = val;
            }

            public QuickFix.Fields.RiskLimitReportRejectReason Get(QuickFix.Fields.RiskLimitReportRejectReason val)
            {
                GetField(val);
                return val;
            }

            public bool IsSet(QuickFix.Fields.RiskLimitReportRejectReason val)
            {
                return IsSetRiskLimitReportRejectReason();
            }

            public bool IsSetRiskLimitReportRejectReason()
            {
                return IsSetField(Tags.RiskLimitReportRejectReason);
            }
