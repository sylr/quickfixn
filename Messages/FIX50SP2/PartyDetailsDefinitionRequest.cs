...
namespace QuickFix
{
    namespace FIX50SP2
    {
        public class PartyDetailsDefinitionRequest : Message
        {
            public const string MsgType = "CX";

            public PartyDetailsDefinitionRequest() : base()
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("CX"));
            }
            ...
            {
                public static int[] fieldOrder = { Tags.ListUpdateAction, Tags.NoPartyDetails, 0 };
