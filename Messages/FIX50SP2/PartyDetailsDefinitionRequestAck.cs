...
namespace QuickFix
{
    namespace FIX50SP2
    {
        public class PartyDetailsDefinitionRequestAck : Message
        {
            public const string MsgType = "CY";

            public PartyDetailsDefinitionRequestAck() : base()
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("CY"));
            }

            public PartyDetailsDefinitionRequestAck(
                    QuickFix.Fields.PartyDetailsListRequestID aPartyDetailsListRequestID,
                    QuickFix.Fields.PartyDetailRequestStatus aPartyDetailRequestStatus
                ) : this()
            {
                this.PartyDetailsListRequestID = aPartyDetailsListRequestID;
                this.PartyDetailRequestStatus = aPartyDetailRequestStatus;
            }
            ...
            public QuickFix.Fields.PartyDetailRequestStatus PartyDetailRequestStatus
            {
                get
                {
                    QuickFix.Fields.PartyDetailRequestStatus val = new QuickFix.Fields.PartyDetailRequestStatus();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.PartyDetailRequestStatus val)
            {
                this.PartyDetailRequestStatus = val;
            }

            public QuickFix.Fields.PartyDetailRequestStatus Get(QuickFix.Fields.PartyDetailRequestStatus val)
            {
                GetField(val);
                return val;
            }

            public bool IsSet(QuickFix.Fields.PartyDetailRequestStatus val)
            {
                return IsSetPartyDetailRequestStatus();
            }

            public bool IsSetPartyDetailRequestStatus()
            {
                return IsSetField(Tags.PartyDetailRequestStatus);
            }
            public QuickFix.Fields.PartyDetailRequestResult PartyDetailRequestResult
            {
                get
                {
                    QuickFix.Fields.PartyDetailRequestResult val = new QuickFix.Fields.PartyDetailRequestResult();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.PartyDetailRequestResult val)
            {
                this.PartyDetailRequestResult = val;
            }

            public QuickFix.Fields.PartyDetailRequestResult Get(QuickFix.Fields.PartyDetailRequestResult val)
            {
                GetField(val);
                return val;
            }

            public bool IsSet(QuickFix.Fields.PartyDetailRequestResult val)
            {
                return IsSetPartyDetailRequestResult();
            }

            public bool IsSetPartyDetailRequestResult()
            {
                return IsSetField(Tags.PartyDetailRequestResult);
            }
            ...
            public QuickFix.Fields.NoPartyUpdates NoPartyUpdates
            {
                get
                {
                    QuickFix.Fields.NoPartyUpdates val = new QuickFix.Fields.NoPartyUpdates();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.NoPartyUpdates val)
            {
                this.NoPartyUpdates = val;
            }

            public QuickFix.Fields.NoPartyUpdates Get(QuickFix.Fields.NoPartyUpdates val)
            {
                GetField(val);
                return val;
            }

            public bool IsSet(QuickFix.Fields.NoPartyUpdates val)
            {
                return IsSetNoPartyUpdates();
            }

            public bool IsSetNoPartyUpdates()
            {
                return IsSetField(Tags.NoPartyUpdates);
            }
            ...
            public class NoPartyUpdatesGroup : Group
            {
                public static int[] fieldOrder = { Tags.ListUpdateAction, Tags.PartyDetailDefinitionStatus, Tags.PartyDetailDefinitionResult, Tags.RejectText, Tags.EncodedRejectTextLen, Tags.EncodedRejectText, Tags.NoPartyDetails, 0 };

                public NoPartyUpdatesGroup()
                  : base(Tags.NoPartyUpdates, Tags.ListUpdateAction, fieldOrder)
                {
                }

                public override Group Clone()
                {
                    var clone = new NoPartyUpdatesGroup();
                    clone.CopyStateFrom(this);
                    return clone;
                }
                ...
                public QuickFix.Fields.PartyDetailDefinitionStatus PartyDetailDefinitionStatus
                {
                    get
                    {
                        QuickFix.Fields.PartyDetailDefinitionStatus val = new QuickFix.Fields.PartyDetailDefinitionStatus();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.PartyDetailDefinitionStatus val)
                {
                    this.PartyDetailDefinitionStatus = val;
                }

                public QuickFix.Fields.PartyDetailDefinitionStatus Get(QuickFix.Fields.PartyDetailDefinitionStatus val)
                {
                    GetField(val);
                    return val;
                }

                public bool IsSet(QuickFix.Fields.PartyDetailDefinitionStatus val)
                {
                    return IsSetPartyDetailDefinitionStatus();
                }

                public bool IsSetPartyDetailDefinitionStatus()
                {
                    return IsSetField(Tags.PartyDetailDefinitionStatus);
                }
                public QuickFix.Fields.PartyDetailDefinitionResult PartyDetailDefinitionResult
                {
                    get
                    {
                        QuickFix.Fields.PartyDetailDefinitionResult val = new QuickFix.Fields.PartyDetailDefinitionResult();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.PartyDetailDefinitionResult val)
                {
                    this.PartyDetailDefinitionResult = val;
                }

                public QuickFix.Fields.PartyDetailDefinitionResult Get(QuickFix.Fields.PartyDetailDefinitionResult val)
                {
                    GetField(val);
                    return val;
                }

                public bool IsSet(QuickFix.Fields.PartyDetailDefinitionResult val)
                {
                    return IsSetPartyDetailDefinitionResult();
                }

                public bool IsSetPartyDetailDefinitionResult()
                {
                    return IsSetField(Tags.PartyDetailDefinitionResult);
                }
