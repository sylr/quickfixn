...
namespace QuickFix
{
    namespace FIX50SP2
    {
        public class PartyRiskLimitsReport : Message
        {
            public const string MsgType = "CM";

            public PartyRiskLimitsReport() : base()
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("CM"));
            }
            ...
            {
                public static int[] fieldOrder = { Tags.NoPartyDetails, Tags.NoRiskLimits, Tags.RiskLimitID, Tags.RiskLimitCheckModelType, Tags.PartyRiskLimitStatus, 0 };

                public NoPartyRiskLimitsGroup()
                  : base(Tags.NoPartyRiskLimits, Tags.NoPartyDetails, fieldOrder)
                {
                }
