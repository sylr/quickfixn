...
namespace QuickFix
{
    namespace FIX50SP2
    {
        public class BidResponse : Message
        {
            ...
            {
                public static int[] fieldOrder = { Tags.Commission, Tags.CommType, Tags.CommCurrency, Tags.FundRenewWaiv, Tags.CommRate, Tags.CommUnitOfMeasure, Tags.ListID, Tags.Country, Tags.Side, Tags.Price, Tags.PriceType, Tags.FairValue, Tags.NetGrossInd, Tags.SettlType, Tags.SettlDate, Tags.TradingSessionID, Tags.TradingSessionSubID, Tags.Text, Tags.EncodedTextLen, Tags.EncodedText, 0 };
                ...
                public QuickFix.Fields.CommRate CommRate
                {
                    get
                    {
                        QuickFix.Fields.CommRate val = new QuickFix.Fields.CommRate();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.CommRate val)
                {
                    this.CommRate = val;
                }

                public QuickFix.Fields.CommRate Get(QuickFix.Fields.CommRate val)
                {
                    GetField(val);
                    return val;
                }

                public bool IsSet(QuickFix.Fields.CommRate val)
                {
                    return IsSetCommRate();
                }

                public bool IsSetCommRate()
                {
                    return IsSetField(Tags.CommRate);
                }
                public QuickFix.Fields.CommUnitOfMeasure CommUnitOfMeasure
                {
                    get
                    {
                        QuickFix.Fields.CommUnitOfMeasure val = new QuickFix.Fields.CommUnitOfMeasure();
                        GetField(val);
                        return val;
                    }
                    set { SetField(value); }
                ...
                public void Set(QuickFix.Fields.CommUnitOfMeasure val)
                {
                    this.CommUnitOfMeasure = val;
                }

                public QuickFix.Fields.CommUnitOfMeasure Get(QuickFix.Fields.CommUnitOfMeasure val)
                {
                    GetField(val);
                    return val;
                }

                public bool IsSet(QuickFix.Fields.CommUnitOfMeasure val)
                {
                    return IsSetCommUnitOfMeasure();
                }

                public bool IsSetCommUnitOfMeasure()
                {
                    return IsSetField(Tags.CommUnitOfMeasure);
                }
