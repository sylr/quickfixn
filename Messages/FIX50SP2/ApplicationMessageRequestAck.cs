    ...
    namespace FIX50SP2
    {
        public class ApplicationMessageRequestAck : Message
        {
            ...
            public class NoApplIDsGroup : Group
            {
                ...
                {
                    public static int[] fieldOrder = { Tags.NestedPartyID, Tags.NestedPartyIDSource, Tags.NestedPartyRole, Tags.NoNestedPartySubIDs, Tags.NestedPartyRoleQualifier, 0 };
                    ...
                    public QuickFix.Fields.NestedPartyRoleQualifier NestedPartyRoleQualifier
                    {
                        get
                        {
                            QuickFix.Fields.NestedPartyRoleQualifier val = new QuickFix.Fields.NestedPartyRoleQualifier();
                            GetField(val);
                            return val;
                        }
                        set { SetField(value); }
                    ...
                    public void Set(QuickFix.Fields.NestedPartyRoleQualifier val)
                    {
                        this.NestedPartyRoleQualifier = val;
                    }

                    public QuickFix.Fields.NestedPartyRoleQualifier Get(QuickFix.Fields.NestedPartyRoleQualifier val)
                    {
                        GetField(val);
                        return val;
                    }

                    public bool IsSet(QuickFix.Fields.NestedPartyRoleQualifier val)
                    {
                        return IsSetNestedPartyRoleQualifier();
                    }

                    public bool IsSetNestedPartyRoleQualifier()
                    {
                        return IsSetField(Tags.NestedPartyRoleQualifier);
                    }
