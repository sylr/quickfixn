...
namespace QuickFix
{
    namespace FIX50SP2
    {
        public class PartyActionReport : Message
        {
            public const string MsgType = "DI";

            public PartyActionReport() : base()
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("DI"));
            }

            public PartyActionReport(
                    QuickFix.Fields.PartyActionReportID aPartyActionReportID,
                    QuickFix.Fields.PartyActionType aPartyActionType,
                    QuickFix.Fields.PartyActionResponse aPartyActionResponse
                ) : this()
            {
                this.PartyActionReportID = aPartyActionReportID;
                this.PartyActionType = aPartyActionType;
                this.PartyActionResponse = aPartyActionResponse;
            }
            ...
            public QuickFix.Fields.PartyActionReportID PartyActionReportID
            {
                get
                {
                    QuickFix.Fields.PartyActionReportID val = new QuickFix.Fields.PartyActionReportID();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.PartyActionReportID val)
            {
                this.PartyActionReportID = val;
            }

            public QuickFix.Fields.PartyActionReportID Get(QuickFix.Fields.PartyActionReportID val)
            {
                GetField(val);
                return val;
            }

            public bool IsSet(QuickFix.Fields.PartyActionReportID val)
            {
                return IsSetPartyActionReportID();
            }

            public bool IsSetPartyActionReportID()
            {
                return IsSetField(Tags.PartyActionReportID);
            }
            ...
            public QuickFix.Fields.PartyActionResponse PartyActionResponse
            {
                get
                {
                    QuickFix.Fields.PartyActionResponse val = new QuickFix.Fields.PartyActionResponse();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.PartyActionResponse val)
            {
                this.PartyActionResponse = val;
            }

            public QuickFix.Fields.PartyActionResponse Get(QuickFix.Fields.PartyActionResponse val)
            {
                GetField(val);
                return val;
            }

            public bool IsSet(QuickFix.Fields.PartyActionResponse val)
            {
                return IsSetPartyActionResponse();
            }

            public bool IsSetPartyActionResponse()
            {
                return IsSetField(Tags.PartyActionResponse);
            }
            public QuickFix.Fields.PartyActionRejectReason PartyActionRejectReason
            {
                get
                {
                    QuickFix.Fields.PartyActionRejectReason val = new QuickFix.Fields.PartyActionRejectReason();
                    GetField(val);
                    return val;
                }
                set { SetField(value); }
            ...
            public void Set(QuickFix.Fields.PartyActionRejectReason val)
            {
                this.PartyActionRejectReason = val;
            }

            public QuickFix.Fields.PartyActionRejectReason Get(QuickFix.Fields.PartyActionRejectReason val)
            {
                GetField(val);
                return val;
            }

            public bool IsSet(QuickFix.Fields.PartyActionRejectReason val)
            {
                return IsSetPartyActionRejectReason();
            }

            public bool IsSetPartyActionRejectReason()
            {
                return IsSetField(Tags.PartyActionRejectReason);
            }
