...
namespace QuickFix
{
    namespace FIX50SP2
    {
        public class PartyDetailsListUpdateReport : Message
        {
            public const string MsgType = "CK";

            public PartyDetailsListUpdateReport() : base()
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("CK"));
            }
