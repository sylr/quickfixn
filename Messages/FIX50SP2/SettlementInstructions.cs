        ...
        public class SettlementInstructions : Message
        {
            ...
            public class NoSettlInstGroup : Group
            {
                ...
                public class NoDlvyInstGroup : Group
                {
                    ...
                    {
                        public static int[] fieldOrder = { Tags.SettlPartyID, Tags.SettlPartyIDSource, Tags.SettlPartyRole, Tags.NoSettlPartySubIDs, Tags.SettlPartyRoleQualifier, 0 };
                        ...
                        public QuickFix.Fields.SettlPartyRoleQualifier SettlPartyRoleQualifier
                        {
                            get
                            {
                                QuickFix.Fields.SettlPartyRoleQualifier val = new QuickFix.Fields.SettlPartyRoleQualifier();
                                GetField(val);
                                return val;
                            }
                            set { SetField(value); }
                        ...
                        public void Set(QuickFix.Fields.SettlPartyRoleQualifier val)
                        {
                            this.SettlPartyRoleQualifier = val;
                        }

                        public QuickFix.Fields.SettlPartyRoleQualifier Get(QuickFix.Fields.SettlPartyRoleQualifier val)
                        {
                            GetField(val);
                            return val;
                        }

                        public bool IsSet(QuickFix.Fields.SettlPartyRoleQualifier val)
                        {
                            return IsSetSettlPartyRoleQualifier();
                        }

                        public bool IsSetSettlPartyRoleQualifier()
                        {
                            return IsSetField(Tags.SettlPartyRoleQualifier);
                        }
