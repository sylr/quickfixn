...
namespace QuickFix
{
    namespace FIX50SP2
    {
        public class PartyEntitlementsDefinitionRequest : Message
        {
            public const string MsgType = "DA";

            public PartyEntitlementsDefinitionRequest() : base()
            {
                this.Header.SetField(new QuickFix.Fields.MsgType("DA"));
            }
            ...
            {
                public static int[] fieldOrder = { Tags.ListUpdateAction, Tags.NoPartyDetails, Tags.NoEntitlements, Tags.EntitlementRefID, Tags.EntitlementStatus, 0 };
